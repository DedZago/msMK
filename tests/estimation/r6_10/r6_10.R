...
setwd("~/Documents/git/MSc-thesis/code/tests/estimation/r6_10/")
...
for(i in 1:mod_sim){
  ...
  name = paste0("r6_10-d", delta, "-a", a, "-i", i,"-indep",indep)
...
library(magrittr)
library(kableExtra)
tab_name = paste0("lpml-", "r6_10-d", delta, "-a", a, "-ind",indep)

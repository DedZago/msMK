...
setwd("~/Documents/git/MSc-thesis/code/tests/estimation/r8_10/")
...
for(i in 1:mod_sim){
  ...
  name = paste0("r8_10-d", delta, "-a", a, "-i", i, "-ind",indep)
...
library(magrittr)
library(kableExtra)
tab_name = paste0("lpml-", "r8_10-d", delta, "-a", a, "-ind",indep)

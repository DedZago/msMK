...
setwd("~/Documents/git/MSc-thesis/code/tests/estimation/r7_2/")
...
for(i in 1:mod_sim){
  ...
  png(paste0("img/true.png"), width = 2200, height = 1200, res = 100) 
  ...
  name = paste0("d", delta, "-a", a, "-i", i,"-ind",indep)
...
library(magrittr)
library(kableExtra)
tab_name = paste0("lpml-", "d", delta, "-a", a,"-ind",indep)

...
setwd("~/Documents/git/MSc-thesis/code/tests/estimation/r7_10/")
...
for(i in 1:mod_sim){
  ...
  name = paste0("r7_10-d", delta, "-a", a, "-i", i,"-indep",indep)
...
library(magrittr)
library(kableExtra)
tab_name = paste0("lpml-", "r7_10-d", delta, "-a", a, "-ind",indep)
